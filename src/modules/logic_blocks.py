...
gives us a single seam to drop in `WordLogicLayer` (Stage 3) and
`ShiftedWordLogicLayer` (Stage 4) without touching every call site.

Per proposal §"Don't touch difflogic CUDA in Stages 1–4", these are
re-exports — no behavioral changes.
"""
